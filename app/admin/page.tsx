...
export default function AdminHome() {
  ...
  if (!user.isAdmin) {
    return (
      <div className="glass-card rounded-lg p-10 text-center text-white/70">
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <Link href="/admin/products" className="glass-card rounded-lg p-6 hover:bg-white/[0.03]">
        ...
        <Link href="/admin/orders" className="glass-card rounded-lg p-6 hover:bg-white/[0.03]">
