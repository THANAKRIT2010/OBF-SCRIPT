...
// Single source of truth: the actual Lua VM/bytecode compiler at the
// project root. No duplicated copy — the web app and the `bin/` CLI both
// import this same engine.
