...
const siteUrl = process.env.NEXT_PUBLIC_SITE_URL || "https://flexozy.xyz";
...
export const metadata: Metadata = {
	...
	title: {
		default: "Flexozy - Lua Code Protection & Minification",
		template: "%s | Flexozy",
	},
	description:
	...
	openGraph: {
		...
		locale: "en_US",
		url: siteUrl,
		title: "Flexozy - Professional Lua Code Protection & Security",
		description:
		...
		images: [
			{
				...
				width: 1200,
				height: 630,
				alt: "Flexozy - Free Online Lua Code Protection Tool with Multiple Obfuscation Techniques",
			},
		],
	},
	twitter: {
							...
							mainEntity: [
								{
									...
									acceptedAnswer: {
										"@type": "Answer",
										text: "Lua code obfuscation is the process of transforming readable Lua source code into functionally equivalent but harder-to-read code. This protects your intellectual property by making it difficult for others to understand, reverse-engineer, or steal your code logic. Flexozy uses multiple techniques including variable name mangling, string encoding, number encoding, and control flow obfuscation.",
									},
								},
								{
									"@type": "Question",
									...
									acceptedAnswer: {
										"@type": "Answer",
										text: "Flexozy supports Lua 5.1, 5.2, 5.3, and 5.4. The tool automatically detects and handles syntax differences between versions, ensuring your obfuscated code remains compatible with your target Lua runtime environment.",
									},
								},
								{
									"@type": "Question",
								...
								},
								{
									...
									acceptedAnswer: {
										"@type": "Answer",
										text: "While no obfuscation is completely irreversible, Flexozy makes reverse engineering significantly more difficult by combining multiple protection techniques. Variable name mangling removes meaningful identifiers, string encoding obscures text literals, number encoding hides numeric values, and control flow obfuscation adds complexity that makes manual analysis time-consuming. The higher the protection level, the more difficult it is to reverse.",
									},
								},
								{
									"@type": "Question",
									name: "Is Flexozy free to use?",
									acceptedAnswer: {
										"@type": "Answer",
										text: "Yes, Flexozy is completely free to use with no registration, account creation, or payment required. All obfuscation happens in your browser, so your code never leaves your device. You can obfuscate unlimited Lua scripts at any protection level.",
									},
								},
								{
									"@type": "Question",
				...
				<script
					...
					dangerouslySetInnerHTML={{
						__html: JSON.stringify({
							...
							description: "Step-by-step guide to protecting your Lua scripts with Flexozy",
							totalTime: "PT2M",
							step: [
								{
									"@type": "HowToStep",
