...
export default function ProfilePage() {
  ...
  return (
    <div className="glass-card rounded-xl overflow-hidden max-w-xl mx-auto">
      ...
      <div className="px-6 pb-6">
        <div className="-mt-12 flex items-end gap-4">
          {user.avatar ? (
            ...
            <div className="size-24 rounded-full border-4 border-[rgb(20,27,46)] accent-btn flex items-center justify-center text-2xl font-bold">
