...
export default function BuyButton({ productId, outOfStock }: { productId: string; outOfStock: boolean }) {
  ...
  if (result) {
    return (
      <div className="glass-card-soft rounded-lg p-4 mt-4">
  ...
  return (
    <div>
      <button
        ...
        className="accent-btn px-6 py-3 rounded-lg w-full sm:w-auto disabled:opacity-40 disabled:cursor-not-allowed"
      >
