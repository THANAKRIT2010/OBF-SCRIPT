...
export default function Footer() {
  return (
    <footer className="glass-card rounded-lg mt-8 overflow-hidden">
      <div className="flex flex-wrap items-center justify-between gap-4 border-b border-white/5 px-4 py-4">
        ...
        <div className="flex gap-3">
          <a
            ...
            rel="noreferrer"
            aria-label="Discord"
            className="size-8 flex items-center justify-center rounded-full text-white/70 hover:text-[#5865f2] transition-colors"
          >
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-3 px-4 py-4 bg-card/25">
