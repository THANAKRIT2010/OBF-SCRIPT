            ...
            {!session ? (
              ...
              <div className="relative" ref={menuRef}>
                <div className="flex items-center gap-2">
                  <button
                    onClick={() => setOpen((v) => !v)}
                    className="flex items-center gap-2 glass-card-soft rounded-lg pl-2 pr-3 py-1.5 hover:bg-white/5"
                  >
                    {avatarSrc ? (
                ...
                {open && (
                  <div className="absolute right-0 mt-2 w-64 glass-card rounded-lg overflow-hidden z-50 shadow-xl shadow-black/40">
